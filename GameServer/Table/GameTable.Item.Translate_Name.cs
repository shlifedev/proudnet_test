...
if(isLoaded) return;
isLoaded = true;
          var textAsset = Resources.Load("TableDatas/GameTable.Item.Translate_Name") as TextAsset;
...
if(isLoaded) return;
isLoaded = true;
          var str = File.ReadAllText("TableDatas/GameTable.Item.Translate_Name" + ".txt");
          var loadedList = JsonConvert.DeserializeObject<List<Translate_Name>>(str);
          for(int i = 0; i < loadedList.Count; i++)
          {
